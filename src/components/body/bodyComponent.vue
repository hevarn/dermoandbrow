<template>
  <div id='wrap'>
   <Wrapper-component /> <!-- v-model="selectedPrestation"-->
  </div>
  <frame-component v-if="serviceSelected !== null" :service="serviceSelected"/> <!--  :prestation="selectedPrestation"-->
  <cursor-component/>
  <load-component/>
  <menu-component/>
...
<script>
import WrapperComponent from "@/components/elements/wrapperComponent.vue";
import LoadComponent from "@/components/body/loadComponent.vue";
import CursorComponent from "@/components/body/cursorComponent.vue";
import FrameComponent from "@/components/body/frameComponent.vue";
import MenuComponent from "@/components/body/menuComponent.vue";
import useEmetter from "@/utils/useEmetter.js";

export default {
  name: "bodyComponent",
  components: {MenuComponent, FrameComponent, CursorComponent, LoadComponent, WrapperComponent},
  data() {
    return {
